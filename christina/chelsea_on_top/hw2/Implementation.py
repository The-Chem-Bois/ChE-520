...
mass_W = np.array([mu1w,mu2w,mu31w,mu32w,mu41w,mu42w,mu51w,mu52w,mu6w,mu71w, mu72w, mu81w, mu82w])
#print('Water Linear Mass Balance')
#print('mu1,mu2,mu31,mu32,mu41,mu42,mu51,mu52, mu6, mu71, mu72, mu81, mu82')
#print(mass_W)

#Ethanol
mu1ea = 1/(1-(eps_abs_V[1]*eps_flash[1]*(1+eta))-((1-eps_flash[1])*(1+eta)+((1-eps_abs_V[1])*eps_flash[1]*(1+eta)))*0.005*0.995)
mu2ea = mu1ea + (eta)*mu1el
...
mu91d = mu82d
mu92d = 0
mu1d = (eps_abs_V[3])*mu41d + 0.995*mu81d
...
flash1 = case1_flash(eps_flash,68.5*750,393, mu2, A,B,C, 2)
