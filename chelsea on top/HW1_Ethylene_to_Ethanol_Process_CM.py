...
T_guess = 310 #Initial temperature guess in K; set to be slightly above the boiling point of DEE to ensure it vaporizes

#T_bubble = bubble_point(P, T_guess, mu, A, B, C, n, Find_T = True) #Calculate the bubble point

#T_dew = dew_point(P, T_guess, mu, A, B, C, n, Find_T = True) #Calculate the dew point
